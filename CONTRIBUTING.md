...
Welcome to `webtrends` contributor's guide.
...
If you experience bugs or general issues with `webtrends`, please have a look
...
You can help improve `webtrends` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`webtrends` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `webtrends`'s files. While this mechanism can
...
```
conda create -n webtrends python=3 six virtualenv pytest pytest-cov
conda activate webtrends
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/webtrends.git
   cd webtrends
   ```
...
5. Install [pre-commit]:
   ...
   `webtrends` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/webtrends
[issue tracker]: https://github.com/<USERNAME>/webtrends/issues
