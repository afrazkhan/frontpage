...
Welcome to `frontpage` contributor's guide.
...
If you experience bugs or general issues with `frontpage`, please have a look
...
You can help improve `frontpage` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`frontpage` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `frontpage`'s files. While this mechanism can
...
```
conda create -n frontpage python=3 six virtualenv pytest pytest-cov
conda activate frontpage
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/frontpage.git
   cd frontpage
   ```
...
5. Install [pre-commit]:
   ...
   `frontpage` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/frontpage
[issue tracker]: https://github.com/<USERNAME>/frontpage/issues
